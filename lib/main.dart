...
import 'vu_meter_painter.dart';
import 'log.dart';

void main() {
  //Parameter optional isDebug default true limitLength default 800
  LogUtil.init(title: "", isDebug: true,limitLength:800);
  runApp(MyApp());
}
...
class _MyAppState extends State<MyApp> {
  ...
  void _onFrame(List<int> frame) {
      if(_smoothedVolumeValue>0.0)
      LogUtil.d("Voice:$frame");
